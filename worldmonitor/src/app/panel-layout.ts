  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open(trinetraMarketingAbsUrl('/about.html'), '_blank');
      default:
        return () => {};
    }
  }
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://worldmonitor-sigma-flax.vercel.app')}"
          ...
          <span class="logo">TRINETRA</span><span class="logo-mobile">TRINETRA</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">TRINETRA</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">TRINETRA</span>
          </div>
        </div>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} TRINETRA</span>
      </footer>
    `;
